 ...
 * @property {() => Promise<{ corporations: string[] }>} getCorporations
 ...
 * @property {(params: { year: string; corporation?: string; department?: string; municipality?: string }) => Promise<{ parties: Array<{ partido: string }> }>} getParties
 * @property {(params: { year: string; corporation?: string; department?: string; municipality?: string; excludeParty?: string }) => Promise<{ data: Array<{ partido: string; totalVotos: number; rank: number }>; excludedParty?: { name: string; totalVotos: number }; totalVotosAmbito: number; totalVotosDepartamento?: number }>} getTopPartidos
